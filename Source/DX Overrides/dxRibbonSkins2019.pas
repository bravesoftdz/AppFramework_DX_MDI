...
begin
  ...
  //MSV: Hack to stop TAT/TAST single color glyph painting...
  APalette.Add(DXBAR_NORMAL, NIL
      {
        TdxSimpleColorPalette.Create(
          dxColorToAlphaColor(AColor), TdxAlphaColors.Empty)
      }
    );
  ...
  //MSV: Hack to stop TAT/TAST single color glyph painting...
  APalette.Add(DXBAR_DISABLED, NIL
      {
        TdxSimpleColorPalette.Create(
          dxColorToAlphaColor(AColor), TdxAlphaColors.Empty)
      }
...
begin
  APalette := TdxRibbonSkinColorPaletteSet.Create;
  APalette.Add(DXBAR_NORMAL, NIL {TdxSimpleColorPalette.Create(
    dxColorToAlphaColor(GetPartColor(rtatpEditText, DXBAR_NORMAL)), TdxAlphaColors.Empty)});
  APalette.Add(DXBAR_DISABLED, NIL {TdxSimpleColorPalette.Create(
